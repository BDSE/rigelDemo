...
const exitCommand = 'rsync -ap --delete ' + context + '/ ' + TC + '/webapps/Rigel/resources';
...
if (isDev) {
    config = merge(config, {
        ...
        //         onBuildExit: ['rsync -ap --delete $code/gitRepositories/rigelDemo/src/main/webapp/resources/ $Tomcat/webapps/Rigel/resources']
        //     })
        // ]
    });
}
